...
- CRITICAL: Do NOT mention source file names, page numbers, or "Source:" metadata in your response.
...
- If the context doesn't contain enough information to answer the question, simply state that the information is not available in the context.
- CRITICAL: Do NOT start your response with phrases like "Based on the provided documents" or "According to the context". Go straight to the answer.
