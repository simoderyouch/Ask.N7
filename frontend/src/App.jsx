        ...
        <ErrorBoundary>
          <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><Loading padding={8} /></div>}>
            <Routes>
              ...
              {/* Main chat route */}
              <Route path="/chat" element={<ErrorBoundary><PrivateRoute element={<GeneralChatPage />} /></ErrorBoundary>} />

              {/* Admin dashboard for document management */}
              <Route path="/admin" element={<ErrorBoundary><PrivateRoute element={<ChatDashboard />} /></ErrorBoundary>} />
